...
const SanityChecker = require('./SanityChecker.js');
...
class ShuffleClient extends EventEmitter {
  constructor(clientOptions) {
    ...
    SanityChecker.checkHooksAreAvailable(this.hooks);
  ...
  async startNewRound(someCoin, poolAmount, serverUri) {
    ...
    let commChannel = new CommChannel({
      serverUri: serverUri
    });
    ...
    commChannel.setShuffleRoundInstance(newShuffleRound);
